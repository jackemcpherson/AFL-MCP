  ...
  return {
    database: {
      ...
      notes: [
        ...
        "match_lineups contains the AFL's official team selections, captured close to match day after late withdrawals are reflected. Distinct from player_match_stats which records who actually played. Non-emergency rows are ~99.95% likely to appear in stats from 2023 onward (residual rate covers very-late withdrawals); 2021–2022 has a ~2% mismatch rate where the historical loader captured pre-change rather than post-change lineups. Emergencies (is_emergency=1) are named as alternates and typically do not play.",
